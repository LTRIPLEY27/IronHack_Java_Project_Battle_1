...
public class Party {
    ...
    public static void test() {
        ...
        Character Merlin = new Wizard("Merlin", Character.generateId(), 1, true, 500, 100);
        Character VatoLoco = new Warrior("Vato Loco", Character.generateId(), 200, true, 500, 100);
        Character VatoLoco2 = new Warrior("Vato Loco", Character.generateId(), 200, true, 500, 100);
